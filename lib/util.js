...
function promisify1(f, thisContext) {
    return function (arg) {
        return new Promise(function (resolve, reject) {
            f.call(thisContext, arg, function (err, result) { return (err !== undefined && err !== null) ? reject(err) : resolve(result); });
        });
    };
}
...
function promisify3(f, thisContext) {
    return function (argA, argB, argC) {
        return new Promise(function (resolve, reject) {
            f.call(thisContext, argA, argB, argC, function (err, result) { return (err !== undefined && err !== null) ? reject(err) : resolve(result); });
        });
    };
}
