            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        if (this.finished) {
                            this.dc.debug("Do request (ERR_FINISHED):\nquery = ".concat(req.getQuery(), "\nvars = ").concat(req.getVarsMap()));
                            this.dc.debug("Do request (ERR_FINISHED):\nmutation = ".concat((0, util_1.stringifyMessage)(mutationList[0])));
                            throw errors_1.ERR_FINISHED;
                        }
                    ...
                    case 8:
                        e_2 = _e.sent();
                        return [3, 9];
                    case 9: throw (0, util_1.isAbortedError)(e_1) || (0, util_1.isConflictError)(e_1) ? errors_1.ERR_ABORTED : e_1;
                    case 10: return [3, 11];
                    case 11:
                        if (req.getCommitNow()) {
                            this.finished = true;
                        ...
                        this.dc.debug("Do request:\nresponse = ".concat((0, util_1.stringifyMessage)(resp)));
                        return [2, resp];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.sent();
                        return [3, 7];
                    case 6: throw (0, util_1.isAbortedError)(e_3) ? errors_1.ERR_ABORTED : e_3;
                    case 7: return [3, 8];
                    case 8: return [2];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.sent();
                        return [3, 7];
                    case 6: throw (0, util_1.isAbortedError)(e_4) ? errors_1.ERR_ABORTED : e_4;
                    case 7: return [3, 8];
                    case 8: return [2];
                }
            });
