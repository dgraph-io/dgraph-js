...
proto.api.Request.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    bestEffort: jspb.Message.getFieldWithDefault(msg, 7, false),
    mutationsList: jspb.Message.toObjectList(msg.getMutationsList(),
    proto.api.Mutation.toObject, includeInstance),
    commitNow: jspb.Message.getFieldWithDefault(msg, 13, false),
...
proto.api.Response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 14:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.api.ListOfString.deserializeBinaryFromReader, "");
         });
      break;
    default:
      reader.skipField();
...
proto.api.Operation.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    runInBackground: jspb.Message.getFieldWithDefault(msg, 6, false)
  };
