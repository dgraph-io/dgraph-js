  ...
  proto.api.Request.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        mutationsList: jspb.Message.toObjectList(
          msg.getMutationsList(),
          proto.api.Mutation.toObject,
          includeInstance,
        ),
...
proto.api.Request.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(12, f, proto.api.Mutation.serializeBinaryToWriter)
  }
...
proto.api.Request.prototype.getRespFormat = function () {
  return /** @type {!proto.api.Request.RespFormat} */ (
  ...
  proto.api.Response.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        hdrsMap: (f = msg.getHdrsMap())
          ? f.toObject(includeInstance, proto.api.ListOfString.toObject)
          : [],
      }
      ...
      case 14:
        ...
        reader.readMessage(value, function (message, reader) {
          jspb.Map.deserializeBinary(
            ...
            proto.api.ListOfString.deserializeBinaryFromReader,
            "",
            new proto.api.ListOfString(),
          )
        })
        break
      default:
...
proto.api.Response.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getTxn()
  if (f != null) {
    writer.writeMessage(2, f, proto.api.TxnContext.serializeBinaryToWriter)
  }
  f = message.getLatency()
  if (f != null) {
    writer.writeMessage(3, f, proto.api.Latency.serializeBinaryToWriter)
  }
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(
      ...
      proto.api.ListOfString.serializeBinaryToWriter,
    )
  }
}
...
proto.api.Response.prototype.getJson_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getJson()))
}
...
proto.api.Response.prototype.getJson_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getJson()))
}
...
proto.api.Response.prototype.getLatency = function () {
  return /** @type{?proto.api.Latency} */ (jspb.Message.getWrapperField(this, proto.api.Latency, 3))
}
...
proto.api.Response.prototype.getMetrics = function () {
  return /** @type{?proto.api.Metrics} */ (jspb.Message.getWrapperField(this, proto.api.Metrics, 4))
}
...
proto.api.Response.prototype.getUidsMap = function (opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
    jspb.Message.getMapField(this, 12, opt_noLazyCreate, null)
  )
}
...
proto.api.Response.prototype.getRdf_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getRdf()))
}
...
proto.api.Response.prototype.getRdf_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getRdf()))
}
...
proto.api.Response.prototype.getHdrsMap = function (opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.api.ListOfString>} */ (
    jspb.Message.getMapField(this, 14, opt_noLazyCreate, proto.api.ListOfString)
  )
}
  ...
  proto.api.Mutation.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        setList: jspb.Message.toObjectList(
          msg.getSetList(),
          proto.api.NQuad.toObject,
          includeInstance,
        ),
        delList: jspb.Message.toObjectList(
          msg.getDelList(),
          proto.api.NQuad.toObject,
          includeInstance,
        ),
...
proto.api.Mutation.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(5, f, proto.api.NQuad.serializeBinaryToWriter)
  }
  f = message.getDelList()
  if (f.length > 0) {
    writer.writeRepeatedMessage(6, f, proto.api.NQuad.serializeBinaryToWriter)
  }
  f = message.getCond()
  if (f.length > 0) {
...
proto.api.Mutation.prototype.getSetJson_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getSetJson()))
}
...
proto.api.Mutation.prototype.getSetJson_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getSetJson()))
}
...
proto.api.Mutation.prototype.getDeleteJson_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getDeleteJson()))
}
...
proto.api.Mutation.prototype.getDeleteJson_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getDeleteJson()))
}
...
proto.api.Mutation.prototype.getSetNquads_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getSetNquads()))
}
...
proto.api.Mutation.prototype.getSetNquads_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getSetNquads()))
}
...
proto.api.Mutation.prototype.getDelNquads_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getDelNquads()))
}
...
proto.api.Mutation.prototype.getDelNquads_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getDelNquads()))
}
  ...
  proto.api.NQuad.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        facetsList: jspb.Message.toObjectList(
          msg.getFacetsList(),
          proto.api.Facet.toObject,
          includeInstance,
        ),
...
proto.api.NQuad.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(4, f, proto.api.Value.serializeBinaryToWriter)
  }
  f = message.getLang()
  if (f.length > 0) {
    writer.writeString(6, f)
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(7, f, proto.api.Facet.serializeBinaryToWriter)
  }
...
proto.api.NQuad.prototype.getObjectValue = function () {
  return /** @type{?proto.api.Value} */ (jspb.Message.getWrapperField(this, proto.api.Value, 4))
}
...
proto.api.Value.prototype.getValCase = function () {
  return /** @type {proto.api.Value.ValCase} */ (
    jspb.Message.computeOneofCase(this, proto.api.Value.oneofGroups_[0])
  )
}
...
proto.api.Value.prototype.getBytesVal_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getBytesVal()))
}
...
proto.api.Value.prototype.getBytesVal_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getBytesVal()))
}
...
proto.api.Value.prototype.getGeoVal_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getGeoVal()))
}
...
proto.api.Value.prototype.getGeoVal_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getGeoVal()))
}
...
proto.api.Value.prototype.getDateVal_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getDateVal()))
}
...
proto.api.Value.prototype.getDateVal_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getDateVal()))
}
...
proto.api.Value.prototype.getDatetimeVal_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getDatetimeVal()))
}
...
proto.api.Value.prototype.getDatetimeVal_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getDatetimeVal()))
}
...
proto.api.Value.prototype.getVfloat32Val_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getVfloat32Val()))
}
...
proto.api.Value.prototype.getVfloat32Val_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getVfloat32Val()))
}
